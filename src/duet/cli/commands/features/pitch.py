...
from duet.features.acoustic.pitch import PitchExtractionConfig
from duet.features.pipelines.acoustics import run_pitch_pipeline
...
def run(args: argparse.Namespace, cfg) -> None:
    ...
    run_pitch_pipeline(
        ...
        source_subject=getattr(args, "source_subject", None),
